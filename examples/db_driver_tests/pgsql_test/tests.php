...
$strsql = 'select * from contacts where id IN ($1, $2)';
...
//***********************************************************************
$strsql2 = 'insert into contacts (id, first_name, last_name, city, state) values ($1, $2, $3, $4, $5)';
...
$strsql3 = 'delete from contacts where id IN ($1, $2)';
